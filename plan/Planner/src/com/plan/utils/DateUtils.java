...
public class DateUtils {
    ...
    /**
     * <p>Checks if a time is within a number of minutes in the future.</p>
     * @param date the time to check, not altered, not null.
     * @param minutes the number of minutes.
     * @return true if the date day is within minutes in the future .
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
...
//        future.add(Calendar.MINUTE, minutes);
//        System.out.println("Checking for miniutes within for " + cal + " Against " + current );
//        System.out.println("cal.after(current)  " + cal.after(current) + "2nd critera " + (cal.getTimeInMillis() - current.getTimeInMillis() ));//< (minutes * 1000) ));
        
        if(cal.after(current) 
        		&& cal.getTimeInMillis() - current.getTimeInMillis() < (minutes * 60 * 1000)) 
        	return true;
        else return false;
    }
